...
Public Class EVentaAdmin

    Private _id_factura As Integer
    Private _id_vendedor As Integer
    Private _nombre_vendedor_ As String
    Private _apellido_vendedor_ As String
    ...
    Public Property Nombre_vendedor_ As String
        Get
            Return _nombre_vendedor_
        End Get
        Set(value As String)
            _nombre_vendedor_ = value
        End Set
    End Property

    Public Property Apellido_vendedor_ As String
        Get
            Return _apellido_vendedor_
        End Get
        Set(value As String)
            _apellido_vendedor_ = value
        End Set
    End Property
