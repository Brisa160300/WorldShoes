Public Class GestionarClientesAdministrador
    ...
    Private Sub BBuscar_Click(sender As Object, e As EventArgs) Handles BBuscar.Click
        If TBBuscar.Text.Trim = "" Then
            objDcliente.clientesAll(dgvListarClientes)
        Else
    ...
    Private Sub GestionarClientesAdministrador_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        objNcliente.cargarGrid(dgvListarClientes)
        objNcliente.cargarComboxDNI(CBBuscarDni)
    End Sub
End Class
