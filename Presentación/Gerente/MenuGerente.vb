Public Class MenuGerente
    ...
    Private Sub BVentasPorMarca_Click(sender As Object, e As EventArgs) Handles BVentasPorMarca.Click
        AbrirFormulariosGerente(New VentasPorMarca)
    End Sub

    Private Sub BVentasPorVendedor_Click_1(sender As Object, e As EventArgs) Handles BVentasPorVendedor.Click
